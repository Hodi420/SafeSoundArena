    ...
    <Layout>
      <section className="space-y-6">
        ...
        <p className="text-gray-600 dark:text-gray-300 max-w-2xl">
          A secure, community-driven arena with live leaderboards, jail events, and license
          verification.
        </p>
...
function Card({ title, desc, href }: { title: string; desc: string; href: string }) {
  return (
    <Link
      href={href}
      className="block p-5 rounded-lg border border-gray-200 dark:border-gray-800 hover:border-blue-500 transition-colors"
    >
