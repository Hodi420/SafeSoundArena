...
export default function AppWalletDemo() {
  const [wallet] = useState<string>(
    'PITEST_0x' + Math.random().toString(36).substring(2, 12).toUpperCase()
  );
  ...
  return (
    <div className="container">
      ...
      <p>
        This is a sample wallet address for demonstration only. In production, connect to a real
        wallet provider.
      </p>
      <div
        style={{
      ...
      >
        {copied ? (
          <svg width="22" height="22" viewBox="0 0 22 22" fill="none" aria-hidden="true">
            <circle cx="11" cy="11" r="11" fill="#e0ffe0" />
            <path
              d="M6.5 11.5l3 3 6-6"
              stroke="#0a4"
              strokeWidth="2.2"
          ...
          <svg width="22" height="22" viewBox="0 0 22 22" fill="none" aria-hidden="true">
            <rect x="6" y="6" width="10" height="12" rx="2" stroke="#0070f3" strokeWidth="1.6" />
            <rect x="4" y="4" width="10" height="12" rx="2" stroke="#0070f3" strokeWidth="1.2" />
          </svg>
        )}
      </IconButton>
