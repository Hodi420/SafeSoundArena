...
// Lightweight icon placeholders to avoid extra dependency
const IconSword = (props: any) => <span {...props}>🗡️</span>;
const IconShield = (props: any) => <span {...props}>🛡️</span>;
const IconBolt = (props: any) => <span {...props}>⚡</span>;
const IconTrophy = (props: any) => <span {...props}>🏆</span>;
