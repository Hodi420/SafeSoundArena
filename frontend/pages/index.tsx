...
const ScrollViewer = () => (
  <div style={{ padding: 16, color: '#ccc' }}>Quest list coming soon!</div>
);
    ...
    <div className="min-h-screen bg-black">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link href="/dashboard">
                <button
                  className="btn-secondary transition hover:scale-105 focus:ring-2 focus:ring-green-400"
      ...
      <section className="w-full bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl shadow mb-12 py-12 px-6 flex flex-col items-center text-center">
        <h1 className="text-4xl md:text-5xl font-extrabold text-blue-700 mb-4">
          Welcome to SafeSoundArena
        </h1>
        <p className="max-w-2xl text-lg md:text-xl text-gray-700 mb-6">
          Embark on quests, join guilds, and earn Pi rewards. Your journey begins here!
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            href="/dashboard"
            className="btn-primary text-lg px-8 py-3 rounded-full shadow hover:scale-105 focus:ring-2 focus:ring-blue-400 transition"
          >
            🚀 Go to Dashboard
          </a>
          <a
            href="/about"
            className="btn-secondary text-lg px-8 py-3 rounded-full shadow hover:scale-105 focus:ring-2 focus:ring-purple-400 transition"
          >
            ℹ️ Learn More
          </a>
        </div>
            ...
            <div className="rounded-xl shadow-lg bg-white p-8 flex flex-col">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="p-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg shadow group transition-all duration-300 hover:scale-105"
                  >
