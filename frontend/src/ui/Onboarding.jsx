...
export default function Onboarding({ onComplete }) {
  ...
  return (
    <div
      style={{ background: '#fff', padding: 24, maxWidth: 400, margin: 'auto', borderRadius: 8 }}
    >
      <h2>צעדים ראשונים</h2>
      <form onSubmit={handleSubmit}>
        ...
        <input
          name="preferences.agentType"
          placeholder="סוג Agent מועדף (רשות)"
          value={form.preferences.agentType}
          onChange={handleChange}
        />
